...
public class Modified2_JExample1_1 implements GLEventListener {
	...
	public static void main(String[] args) {
		...
		glWindow.addGLEventListener(new Modified2_JExample1_1());
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glClearBufferfv(GL4.GL_COLOR, 0, white, 0);
